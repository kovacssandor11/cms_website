...
export interface ApiFlyingMachineFlyingMachine
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    weapons: Schema.Attribute.Relation<'manyToMany', 'api::weapon.weapon'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHeroTextHeroText extends Struct.SingleTypeSchema {
...
export interface ApiWeaponWeapon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Name: Schema.Attribute.String;
    flying_machines: Schema.Attribute.Relation<
      'manyToMany',
      'api::flying-machine.flying-machine'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::weapon.weapon'>;
  };
}
